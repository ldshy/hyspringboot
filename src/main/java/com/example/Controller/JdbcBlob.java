...
public class JdbcBlob {
    public static void main(String[] args) throws SQLException {
         ...
         */
        String connectionURL = "jdbc:mysql://localhost:3306/new?useUnicode=true&characterEncoding=UTF-8";
        /*
        ...
        try {
            ...
            // as parameter.
            File image = new File("D:/005.jpg");
            /*
             * prepareStatement() is used for create statement object that is
             * used for sending sql statements to the specified database.
             */
            psmnt = connection
                    .prepareStatement("insert into hy_spring(username, userage, img) values(?,?,?)");
            psmnt.setString(1, "大学");
            psmnt.setString(2, "5");
